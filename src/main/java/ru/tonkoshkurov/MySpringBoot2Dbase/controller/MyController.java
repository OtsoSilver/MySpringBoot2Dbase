package ru.tonkoshkurov.MySpringBoot2Dbase.controller;
...
import ru.tonkoshkurov.MySpringBoot2Dbase.service.AcademicDisciplinesService;
import ru.tonkoshkurov.MySpringBoot2Dbase.service.StudentService;
...
public class MyController {
    ...
    public ResponseEntity<List> allDisciplines() {
        ...
        if (allDisciplines.isEmpty()) return new ResponseEntity<>(allDisciplines, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<Discipline> getDisciplines(@PathVariable("id") int id) {
        ...
        if (discipline == null) return new ResponseEntity<>(discipline, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<Discipline> saveDisciplines(@RequestBody Discipline discipline) {
        ...
        if (returnedDiscipline == null) return new ResponseEntity<>(returnedDiscipline, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Discipline> updateDisciplines(@RequestBody Discipline discipline) {
        ...
        if (updatedDiscipline == null) return new ResponseEntity<>(updatedDiscipline, HttpStatus.CONFLICT);
